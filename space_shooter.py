...
#background
BG = pygame.transform.scale(pygame.image.load(os.path.join("assets", "backgroundimage.png")), (WIDTH, HEIGHT))

#player and enemies can shoot. Only Y-axel
class Laser:
...
def main_menu():
    ...
    while run:
        ...
        title_label2 = title_font2.render("WASD to move, SPACE to shoot", 1, (255,255,255))
